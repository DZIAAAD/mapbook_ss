# from mapbook.map_functions import multiple_user_map
...
def show_users():
     ...
     querry = "SELECT name,surname,posts,location,st_astext(coordinates),id FROM public.users ORDER BY id ASC "
     ...
     for idx, user in enumerate(users_db):
          ...
          listbox_lista_obietktow.insert(idx,f'{user[0]} {user[1]} {user[2]} {user[3]}')
...
label_szczegoly_postow = Label(ramka_szczegoly_obiektu, text='Postów: ')
